  ...
  return (
    ...
    >
      <div className="kpi-top">
        ...
        {/* trend comes from backend daily_comparison — no arbitrary value */}
...
export default function Reports() {
  ...
  // health_score is now calculated by the backend — not derived here.
  ...
  const hydrationStatus =
    analytics.avg_water >= 2 ? "Excellent" : "Needs Improvement";
  const sleepStatus =
    analytics.avg_sleep >= 7 ? "Healthy" : "Needs Improvement";
  const stepsGoal = analytics.total_steps >= 10000 ? "Achieved" : "Pending";
  const fitnessLevel =
        ...
        >
          <div className="section-header">
            ...
            <p className="section-subtitle">
              Your lifetime fitness numbers at a glance
            </p>
          </div>
        ...
        <div className="reports-bottom-grid">
          ...
          >
            ...
            <div className="insight-list">
              <InsightRow
                ...
                value={`${analytics.workout_completion_rate}%`}
                status={
          ...
          >
            ...
            <div className="insight-list">
              ...
              <InsightRow
                label="Hydration"
                value={`${analytics.avg_water} L / day`}
                status={hydrationStatus}
                icon={Droplets}
                color="#06B6D4"
              />
